        ...
        <View style={styles.frame} pointerEvents='box-none'>
          <Interactable.View
            ...
            <Animated.View
              ...
              <Image style={styles.image} source={{ uri: 'https://api.adorable.io/avatars/81/abott@adorable.png' }} />
            </Animated.View>
          </Interactable.View>
        </View>
        ...
        <View style={styles.frame} pointerEvents='box-none'>
          <Interactable.View
            ...
            <Animated.View
              ...
              <Image style={styles.image} source={{ uri: 'https://api.adorable.io/avatars/88/abott@adorable.png' }} />
            </Animated.View>
          </Interactable.View>
        </View>
      }
