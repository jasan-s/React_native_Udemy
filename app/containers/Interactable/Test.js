      ...
      <View style={styles.container}>
        ...
        <Interactable.View
          ...
          <Animated.View
            ...
            <Image style={styles.image} source={require('~/images/airport-photo.jpg')} />

            <Animated.View
              style={[styles.overlay, { backgroundColor: '#de6d77' }, {
            ...
            <Animated.View
              style={[styles.overlay, { backgroundColor: '#2f9a5d' }, {
                opacity: this._deltaX.interpolate({
                  inputRange: [0, 120],
                  outputRange: [0, 0.8],
                  extrapolateLeft: 'clamp',
